...
console.log('isToday(before)', isToday(before));

// date-fns formatting options
console.log('format(now)', format(now, 'yyyy-MMM-dd HH:mm:ss'));
console.log('format(now)', format(now, 'EEEE MMMM dd, yyyy HH:mm:ss'));
console.log('formatDistance', formatDistance(before, now, {addSuffix: true}));